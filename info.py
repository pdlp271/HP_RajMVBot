...
PICS = (environ.get('PICS', 'https://graph.org/file/cda536d7a86c25eb41fd0-576bb11b1cc70ef5ea.jpg https://graph.org/file/5ef13477e361c3fa38e87-a77f341e95d44f6b79.jpg https://graph.org/file/7eff7aba3e785a7108e24-d243d62351cc996726.jpg https://graph.org/file/8689b5c888cb5ab0d751f-d90b6fc08fa22ae56e.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/819dd1a293d5fea054e07-d509d6c5c97bab7fe9.jpg")
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002611366051'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002701898228'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002647662043')  # Channel/Group ID for force sub (make sure bot is admin)
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002701898228')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002647662043').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002647662043').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/c2f45e36bf24ecc88d167-d5e39d512dcadbcbd0.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'masterprajwalraj@fam')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://HPRaj271:HPRaj271@cluster0.xoqwdlz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://HP_Raj271:HP_Raj271@cluster0.xomjcdr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "HPRaj271")
...
CAPTION_LANGUAGES = ["Kannada", "Hindi", "Bengali", "Tamil", "English", "Bangla", "Telugu", "Malayalam", "Bhojpuri", "Marathi", "Punjabi", "Bengoli", "Gujrati", "Korean", "Gujarati", "Spanish", "French", "German", "Chinese", "Arabic", "Portuguese", "Russian", "Japanese", "Odia", "Assamese", "Urdu"]
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1001965914571'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/Howtoopenlink271/41')  # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/HowtodownloadLink271/3')  # Tutorial video link for opening shortlink website
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+DWu_QXl2Ydg3N2Zl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/HP_Raj_Movies')
OWNER_LNK = environ.get('OWNER_LNK', 'http://t.me/HP_Raj_Support_Bot')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+DdA9O8bwZ0ljODk1')
OWNERID = int(os.environ.get('OWNERID', '8005648537'))  # Replace with the actual admin ID
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', BIN_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002505290516')).split()]
