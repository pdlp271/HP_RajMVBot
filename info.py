...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002355254553')  # Support group id (make sure bot is admin)
...
OWNER_LNK = environ.get('OWNER_LNK', 'https:/t.me/Master_HP_Raj01')
