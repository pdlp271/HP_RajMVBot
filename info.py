...
MELCOW_VID = environ.get("MELCOW_VID", "https://i.ibb.co/5qhPhRy/photo-2025-08-01-18-34-19-7533687312257908752.jpg")
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002647662043 -1002611366051').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'zegalinks.com')
SHORTLINK_API = environ.get('SHORTLINK_API', '1d933214e9afa52247c70d2cfbc8543f4b9b197f')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/HowtoopenLink02/5')  # Tutorial video link for opening shortlink website
